...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('otp', 'SystemController@otp')->name('otp');
        Route::get('verifyotp', 'SystemController@verifyotp')->name('verifyotp');
        ...
        Route::group(['prefix' => 'food', 'as' => 'food.', 'middleware' => ['module:food']], function () {
            ...
            Route::group(['prefix' => 'special', 'as' => 'special.', 'middleware' => ['module:food']], function () {
                Route::get('add-new', 'FoodController@special_add')->name('add-new');
                Route::get('edit/{id}', 'FoodController@special_edit')->name('edit');
                Route::get('list', 'FoodController@special_list')->name('list');
            });
            Route::group(['prefix' => 'today', 'as' => 'today.', 'middleware' => ['module:food']], function () {
                Route::get('add-new', 'FoodController@today_add')->name('add-new');
                Route::get('edit/{id}', 'FoodController@today_edit')->name('edit');
                Route::get('list', 'FoodController@today_list')->name('list');
            });
            Route::group(['prefix' => 'upcoming', 'as' => 'upcoming.', 'middleware' => ['module:food']], function () {
                Route::get('add-new', 'FoodController@upcoming_add')->name('add-new');
                Route::get('edit/{id}', 'FoodController@upcoming_edit')->name('edit');
                Route::get('list', 'FoodController@upcoming_list')->name('list');
            });
            Route::get('remove-image', 'FoodController@remove_image')->name('remove-image');
