...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::get('get-products-list/{status}', 'VendorController@get_products');
        ...
        Route::group(['prefix'=>'product'], function(){
            ...
            Route::post('upload-images', 'FoodController@upload_images');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('date-wise', 'ProductController@get_date_wise_products');
        Route::get('special-food', 'ProductController@get_special_products');
        Route::get('today-food', 'ProductController@get_today_products');
        Route::get('upcoming-food', 'ProductController@get_upcoming_products');
