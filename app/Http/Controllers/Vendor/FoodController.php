...
class FoodController extends Controller
{
    ...
    public function special_add(){
        ...
        $categories = Category::where(['position' => 0])->get();
        return view('vendor-views.product.special.index', compact('categories'));
    }
     ...
     public function today_add(){
        ...
        $categories = Category::where(['position' => 0])->get();
        return view('vendor-views.product.today.index', compact('categories'));
    }
    ...
    public function upcoming_add(){
        ...
        $categories = Category::where(['position' => 0])->get();
        return view('vendor-views.product.upcoming.index', compact('categories'));
    }
    ...
    public function special_list(Request $request)
    {
        ...
        return view('vendor-views.product.special.list', compact('foods', 'category', 'type'));
    }
    ...
    public function today_list(Request $request)
    {
        ...
        ->type($type)->latest()->paginate(config('default_pagination'));
        $category =$category_id !='all'? Category::findOrFail($category_id):null;   
        return view('vendor-views.product.today.list', compact('foods', 'category', 'type'));
    }
     ...
     public function upcoming_list(Request $request)
    {
        ...
        ->type($type)->latest()->paginate(config('default_pagination'));
        $category =$category_id !='all'? Category::findOrFail($category_id):null;   
        return view('vendor-views.product.upcoming.list', compact('foods', 'category', 'type'));
    }
    ...
    public function special_edit($id)
        ...
        return view('vendor-views.product.special.edit', compact('product', 'product_category', 'categories','product_images'));
    }
    ...
    public function today_edit($id)
        ...
        $product_images = json_decode($product->image);
        $categories = Category::where(['parent_id' => 0])->get();
        return view('vendor-views.product.today.edit', compact('product', 'product_category', 'categories','product_images'));
    }
    ...
    public function upcoming_edit($id)
        ...
        $product_images = json_decode($product->image);
        $categories = Category::where(['parent_id' => 0])->get();
        return view('vendor-views.product.upcoming.edit', compact('product', 'product_category', 'categories','product_images'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $food->upcoming = 1;
        $food->today = 0;
                $food->available_date = date('Y-m-d', strtotime('-1 day', strtotime($request->food_available_date)));
        ...
        $p->available_date = $request->food_available_date;
         ...
         if($p->upcoming == 1){
              $p->special_food =0;
                ...
                $p->available_date = date('Y-m-d', strtotime('-1 day', strtotime($request->food_available_date)));
