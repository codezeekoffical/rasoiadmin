...
class ProductLogic
{
    ...
    public static function popular_products($zone_id, $limit = null, $offset = null, $type)
    {
     ...
     public static function datewise_products($zone_id, $limit = null, $offset = null, $type, $date)
    {
        if($limit != null && $offset != null)
        {
            $paginator = Food::whereHas('restaurant', function($q)use($zone_id){
        ...
        $paginator = Food::active()->type($type)->whereHas('restaurant', function($q)use($zone_id){
            $q->where('zone_id', $zone_id)->Weekday();
        })->whereDate('delivery_date', date($date))->where('upcoming', 1)->popular()->limit(50)->get();
    ...
    public function upcoming_products($zone_id, $limit = null, $offset = null, $type)
     {
        if($limit != null && $offset != null)
        {
            $paginator = Food::whereHas('restaurant', function($q)use($zone_id){
        ...
        $paginator = Food::active()->type($type)->whereHas('restaurant', function($q)use($zone_id){
            $q->where('zone_id', $zone_id)->Weekday();
        })->where('upcoming', 1)->popular()->limit(50)->get();
    ...
    public static function today_products($zone_id, $limit = null, $offset = null, $type)
    {
        if($limit != null && $offset != null)
        {
            $paginator = Food::whereHas('restaurant', function($q)use($zone_id){
        ...
        $paginator = Food::active()->type($type)->whereHas('restaurant', function($q)use($zone_id){
            $q->where('zone_id', $zone_id)->Weekday();
        })->where('today', 1)->popular()->limit(50)->get();
     ...
     public static function special_products($zone_id, $limit = null, $offset = null, $type)
    {
        if($limit != null && $offset != null)
        {
            $paginator = Food::whereHas('restaurant', function($q)use($zone_id){
        ...
        $paginator = Food::active()->type($type)->whereHas('restaurant', function($q)use($zone_id){
            $q->where('zone_id', $zone_id)->Weekday();
        })->where('special_food', 1)->popular()->limit(50)->get();
