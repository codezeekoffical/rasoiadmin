...
class Helpers
{
    ...
    public static function product_data_formatting($data, $multi_data = false, $trans = false, $local='en')
    {
        ...
        if ($multi_data == true) {
            foreach ($data as $item) {
                ...
                {
                    $images[] = ['image'=>(string)$value->image];
                }
    ...
    public static function order_details_data_formatting($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $item['food_type'] = json_decode($item['food_type']);
    ...
    public static function upload(string $dir, string $format, $image = null)
    {
     ...
     public static function videoupload(string $dir, string $format, $image = null)
    {
        if ($image != null) {
            $imageName = \Carbon\Carbon::now()->toDateString() . "-" . uniqid() . "." . $format;
            if (!Storage::disk('public')->exists($dir)) {
    ...
    public static function delete(string $dir, $image){
