                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/food*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="nav-item {{Request::is('vendor-panel/food/special/add-new')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.special.add-new')}}"
                                    title="add new food">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="text-truncate">Special {{__('messages.add')}} {{__('messages.new')}}</span>
                                </a>
                            </li>
                             <li class="nav-item {{Request::is('vendor-panel/food/today/add-new')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.today.add-new')}}"
                                    title="add new food">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="text-truncate">Today {{__('messages.add')}} {{__('messages.new')}}</span>
                                </a>
                            </li>
                             <li class="nav-item {{Request::is('vendor-panel/food/upcoming/add-new')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.upcoming.add-new')}}"
                                    title="add new food">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="text-truncate">Upcoming {{__('messages.add')}} {{__('messages.new')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('vendor-panel/food/special/list')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.special.list')}}" title="food list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">special {{__('messages.list')}}</span>
                                </a>
                            </li>
                             <li class="nav-item {{Request::is('vendor-panel/food/today/list')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.today.list')}}" title="food list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Today {{__('messages.list')}}</span>
                                </a>
                            </li>
                             <li class="nav-item {{Request::is('vendor-panel/food/upcoming/list')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.food.upcoming.list')}}" title="food list">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Upcoming {{__('messages.list')}}</span>
                                </a>
                            </li>
