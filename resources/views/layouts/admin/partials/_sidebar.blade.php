                    ...
                    @if(\App\CentralLogics\Helpers::module_permission_check('food'))
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/food*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/food/today/add-new')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.today.add-new')}}"
                                       title="{{__('messages.add')}} {{__('messages.new')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{__('messages.add')}} Today {{__('messages.food')}} </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/food/upcoming/add-new')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.upcoming.add-new')}}"
                                       title="{{__('messages.add')}} {{__('messages.new')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{__('messages.add')}} Upcoming {{__('messages.food')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/food/special/add-new')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.special.add-new')}}"
                                       title="{{__('messages.add')}} {{__('messages.new')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{__('messages.add')}} Special {{__('messages.food')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/food/special/list')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.special.list')}}"
                                       title="{{__('messages.food')}} {{__('messages.list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Special {{__('messages.list')}}</span>
                                    </a>
                                </li>
                                 <li class="nav-item {{Request::is('admin/food/upcoming/list')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.upcoming.list')}}"
                                       title="{{__('messages.food')}} {{__('messages.list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">Upcoming {{__('messages.list')}}</span>
                                    </a>
                                </li>
                                 <li class="nav-item {{Request::is('admin/food/today/list')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.food.today.list')}}"
                                       title="{{__('messages.food')}} {{__('messages.list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
