...
@section('title', 'Add Upcoming Food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} Upcoming {{__('messages.new')}} {{__('messages.food')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                       ...
                       <!-- <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="delivery_date" class="form-control"  id="available_time_ends" required>
                            </div>
                        </div>
                    </div> 
