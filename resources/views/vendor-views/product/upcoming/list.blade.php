...
@section('title','Upcoming Food List')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i>Upcoming {{__('messages.food')}} {{__('messages.list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$foods->total()}}</span></h1>
                </div>
                ...
                <div class="col-sm-auto">
                    <a href="{{route('vendor.food.upcoming.add-new')}}" class="btn btn-primary pull-right"><i
                                class="tio-add-circle"></i> {{__('messages.add')}} Upcoming {{__('messages.new')}} {{__('messages.food')}}</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('vendor.food.upcoming.edit',[$food['id']])}}" title="{{__('messages.edit')}} {{__('messages.food')}}"><i class="tio-edit"></i>
                                        </a>
