...
@section('title','Update Upcoming Food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>{{__('messages.update')}} Upcoming {{__('messages.food')}} </h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                       ...
                       <!-- <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="{{date('Y-m-d\TH:i', strtotime($product['delivery_date']))}}" name="delivery_date" class="form-control"  id="available_time_ends" required>
                            </div>
                        </div>
                    </div> 
