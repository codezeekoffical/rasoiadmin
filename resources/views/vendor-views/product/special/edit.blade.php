...
@section('title','Update Special Food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>{{__('messages.update')}} Special {{__('messages.food')}} </h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                   ...
                   <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="food_available_date" value="{{date('Y-m-d\TH:i', strtotime($product['available_date']))}}" class="form-control" id="available_time_starts"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="delivery_date" class="form-control" value="{{date('Y-m-d\TH:i', strtotime($product['delivery_date']))}}"  id="available_time_ends" placeholder="5:45 pm" required>
                            </div>
                        </div>
                    </div> 
                  ...
                  <div class="form-group">
                                     ...
                                     <div class="p-2 border border-dashed" style="max-width:430px;">
                                        <div class="row" id="coba">
                                            @php ($key = array_keys($product_images))
                                                            @php($size = sizeof($key))
                                                            @for( $i = 0; $i < $size; $i++)
                                                <div class="col-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img style="width: 100%" height="auto"
                                                                 ...
                                                                 src="{{asset('storage/app/public/product')}}/{{$product_images[$i]->image}}"
                                                                 alt="Product image">
                                                            <a href="{{route('vendor.food.remove-image',['id'=>$product['id'],'name'=>$product_images[$i]->image])}}"
            ...
            $.post({
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        setTimeout(function () {
                            location.href = '{{\Request::server('HTTP_REFERER')??route('vendor.food.list')}}';
                        }, 2000);
                    }
                }
            });
