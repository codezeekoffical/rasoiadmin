    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-6">
                    @if($product['special_food'] == 1)
                    <a href="{{route('vendor.food.special.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                     @if($product['upcoming'] == 1)
                    <a href="{{route('vendor.food.upcoming.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                     @if($product['today'] == 1)
                    <a href="{{route('vendor.food.today.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                </div>
                ...
                <div class="row align-items-md-center">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            @php ($product_images = json_decode($product['image']))
