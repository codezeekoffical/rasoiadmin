...
@section('title','Update Today Food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>{{__('messages.update')}} Today {{__('messages.food')}} </h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" 
                                       ...
                                       placeholder="Ex : 10:30 am" value="{{$product['available_time_starts']}}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" 
                                       name="available_time_ends" class="form-control" id="available_time_ends" placeholder="5:45 pm" value="{{$product['available_time_ends']}}"
                                       required>
                            </div>
                        </div>
                    </div>
