                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="f_name" class="form-control" value="{{old('f_name')}}" placeholder="{{__('messages.first')}} {{__('messages.name')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="l_name" class="form-control" value="{{old('l_name')}}" placeholder="{{__('messages.last')}} {{__('messages.name')}}"
                                       required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{old('email')}}" class="form-control" placeholder="Ex : ex@example.com"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="tel" name="tel" id="phone" value="{{old('tel')}}"placeholder="Ex : 017********" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
