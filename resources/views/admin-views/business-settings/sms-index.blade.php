             ...
             <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">Custom SMS</h5>
                        <span class="badge badge-soft-info mb-3">NB : Keep an OTP variable in your SMS providers OTP Template.</span>
                        @php($config=\App\CentralLogics\Helpers::get_business_settings('custom_sms'))
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.sms-module-update',['custom_sms']):'javascript:'}}"
                            method="post">
                            @csrf

                            <div class="form-group mb-2">
                                <label class="control-label">Custom Sms</label>
                            </div>
