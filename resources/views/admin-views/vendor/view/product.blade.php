                ...
                <div class="col-md-12">
                    <div class="card h-100">
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.food.special.add-new')}}" class="btn btn-primary"><i
                                        class="tio-add-circle"></i> {{__('messages.add')}}  Special {{__('messages.food')}}</a>
                            <a href="{{route('admin.food.upcoming.add-new')}}" class="btn btn-primary"><i
                                        class="tio-add-circle"></i> {{__('messages.add')}}  Upcoming {{__('messages.food')}}</a>
                            <a href="{{route('admin.food.today.add-new')}}" class="btn btn-primary"><i
                                        class="tio-add-circle"></i> {{__('messages.add')}}  Today {{__('messages.food')}}</a>
                        </div>
                        <div class="table-responsive datatable-custom">
                            <table id="columnSearchDatatable"
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>
                                        @php ($product_images = json_decode($food['image']))
                                        <a class="media align-items-center" href="{{route('admin.food.view',[$food['id']])}}">
                                            <img class="avatar avatar-lg mr-3" src="{{asset('storage/app/public/product')}}/{{$product_images[0]->image}}" 
                                    ...
                                    <td>
                                       @if ($food['special_food'] == 1)
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.food.special.edit',[$food['id']])}}" title="{{__('messages.edit')}} {{__('messages.food')}}"><i class="tio-edit"></i>
                                        </a>
                                        @endif
                                        @if ($food['upcoming'] == 1)
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.food.upcoming.edit',[$food['id']])}}" title="{{__('messages.edit')}} {{__('messages.food')}}"><i class="tio-edit"></i>
                                        </a>
                                        @endif
                                        @if ($food['today'] == 1)
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.food.today.edit',[$food['id']])}}" title="{{__('messages.edit')}} {{__('messages.food')}}"><i class="tio-edit"></i>
                                        </a>
                                        @endif
