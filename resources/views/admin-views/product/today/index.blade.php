...
@section('title','Add New Today food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} Today {{__('messages.food')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
