        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <a href="{{route('admin.food.special.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                     @if($product['upcoming'] == 1)
                    <a href="{{route('admin.food.upcoming.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                     @if($product['today'] == 1)
                    <a href="{{route('admin.food.today.edit',[$product['id']])}}" class="btn btn-primary float-right">
                        <i class="tio-edit"></i> {{__('messages.edit')}}
                    </a>
                    @endif
                </div>
