                ...
                <form action="javascript:" method="post" id="food_form"
                    ...
                    <div class="row mt-2">
                     ...
                     <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">Select Food Type<span
                                        class="input-label-secondary" title="{{__('messages.restaurant_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.restaurant_required_warning')}}"></span></label>                                
                                <select name="food_type[]" class="form-control js-select2-custom" multiple="multiple" required>
                     ...
                     <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">Special Food <span
                                        class="input-label-secondary" title="{{__('messages.restaurant_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.restaurant_required_warning')}}"></span></label>                                
                               <select name="special" class="form-control js-select2-custom">
                   ...
                   <!--   <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">Select Food Available Date<span
                                        class="input-label-secondary" title="{{__('messages.restaurant_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.restaurant_required_warning')}}"></span></label>              <input type="datetime-local" name="food_available_date" class="form-control" required>                  
                 ...
                 <!--    <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlSelect1">Select Day on which food available<span
                                        class="input-label-secondary" title="{{__('messages.restaurant_required_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.restaurant_required_warning')}}"></span></label>                                
                                <select name="food_availability[]" class="form-control js-select2-custom" multiple="multiple" required>
                      ...
                      <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Select Food Available Date</label>
                                <input type="datetime-local" name="food_available_date" class="form-control" id="available_time_starts"
                                       placeholder="Ex : 10:30 am" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Select Food Delivery Date</label>
                                <input type="datetime-local" name="delivery_date" class="form-control"  id="available_time_ends" placeholder="5:45 pm" rewuired>
                            </div>
                        </div>
                    </div> 
...
<!--                    <div class="row">
                    ...
                    <div class="form-group">
                        <label>{{__('messages.food')}} video </label>
                        <div class="custom-file">
                            <input type="file" name="video" class="custom-file-input" id="customFileEg2"
                                   accept=".mp4" >
                            <label class="custom-file-label" for="customFileEg2">{{__('messages.choose')}} {{__('messages.file')}}</label>
                        </div>
                         <center style="display: none" id="video-viewer-section" class="pt-2">
                           <div>Video Added Successfully !</div>
                        </center>
                    ...
                    <hr>
                     <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="image[]" multiple id="customFileEg1" class="custom-file-input"
                    ...
                    <hr>
                      <div class="form-group">
                        <label>{{__('messages.food')}} {{__('messages.image')}}</label><small style="color: red">* ( {{__('messages.ratio')}} 1:1 )</small>
                        <div class="custom-file">
                            <input type="file" name="image[]" multiple id="customFileEg2" class="custom-file-input"
                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" required>
                            <label class="custom-file-label" for="customFileEg2">{{__('messages.choose')}} {{__('messages.file')}}</label>
