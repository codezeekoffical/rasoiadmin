...
@section('title','Add New Special food')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{__('messages.add')}} {{__('messages.new')}} Special {{__('messages.food')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
               ...
               <!--      <div class="row mt-2">
                ...
                <!--      <div class="row">
                       <!-- <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="delivery_date" class="form-control"  id="available_time_ends" min="{{date('Y-m-d')}}" required>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <input type="hidden" name="special" value="1">
                     ...
                     <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Select Food Delivery Date</label>
                                <input type="datetime-local" name="delivery_date" class="form-control"  id="available_time_ends" placeholder="5:45 pm" required>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="video" class="custom-file-input" id="video"
                                   accept=".mp4" >
                            <label class="custom-file-label" for="">{{__('messages.choose')}} {{__('messages.file')}}</label>
                        </div>
                         <center class="d-none" id="video-viewer-section" class="pt-2">
                    ...
                    <div class="form-group">
                                        <label>{{__('messages.food')}} {{__('messages.image')}}</label><small
...
<script type="text/javascript">
    ...
    <script>
        ...
        $("#video").change(function (){
            $('#video-viewer-section').removeClass('d-none');
        })
