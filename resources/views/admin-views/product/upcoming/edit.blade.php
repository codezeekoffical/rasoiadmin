...
@section('title','Update Upcoming product')
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>Upcoming {{__('messages.food')}} {{__('messages.update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img style="width: 100%" height="auto"
                                                                 ...
                                                                 alt="Product image">
                                                            <a href="{{route('admin.food.remove-image',['id'=>$product['id'],'name'=>$product_images[$i]->image])}}"
